...
| 17 | platform | **Deployment fails** with `An unknown exception has occurred` in every run since 2026-09-11 | Follow the diagnosis in [deployment.md](operations/deployment.md#deployment-failure-an-unknown-exception-has-occurred); possibly an Azure regression – new SWA in another region or support request |
