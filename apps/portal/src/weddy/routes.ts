    ...
    children: [
      {
        ...
        component: () => import('./wedding/DashboardView.vue'),
      },
      {
        path: 'weddings/new',
        name: 'weddy-wedding-new',
        component: () => import('./wedding/WeddingNewView.vue'),
      },
      {
        path: 'weddings/:weddingId',
        component: () => import('./wedding/WeddingLayout.vue'),
        children: [
          { path: '', redirect: (to) => weddyPath(`/weddings/${to.params['weddingId']}/couple`) },
          { path: 'couple', name: 'weddy-couple', component: () => import('./wedding/CoupleView.vue') },
          { path: 'guests', name: 'weddy-guests', component: () => import('./guests/GuestsView.vue') },
          {
            path: 'planning',
            name: 'weddy-planning',
